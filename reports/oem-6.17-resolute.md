...
_Generated: 2026-08-28 14:06:12 UTC_
...
**Summary:** 19 found, 5 not found · 8 ready to apply (ACK'd with ≥2 ACKs)

## Ready to apply (≥2 ACKs)

- `38573fd563ab` ACK/CMNT*2 — ASoC: SDCA: Move kcontrol search out of IRQ
- `d9db0ad11c05` ACK/CMNT*2 — ASoC: SDCA: Switch to fixup_controls callback for IRQ registration
- `0f380e30f69f` ACK/CMNT*2 — ASoC: Add a component fixup_controls callback
- `38cf850fdb21` ACK/CMNT*2 — ASoC: SDCA: Populate IRQ data earlier
- `ef19b0a3e699` ACK/CMNT*2 — ASoC: SDCA: Remove devm from primary IRQ cleanup
- `71959b21f984` ACK/CMNT*2 — ASoC: SDCA: Add sdca_irq_cleanup_late()
- `b2e62a968554` ACK/CMNT*2 — ASoC: SDCA: Rename sdca_irq_allocate() to include devm
- `a5979f4d88c1` ACK/CMNT*2 — ASoC: SDCA: Correct kernel doc for sdca_irq_cleanup()

## All checked commits

| Hash | Subject | Public bug | Private bug | Emailed? | Version | Match | Link | Found In | Signed-off-by |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `e9c4c6c91471` | ASoC: sdw_utils: Add missed component_name strings for TI amps | [2164504](https://bugs.launchpad.net/bugs/2164504) | [stella-3568](https://warthogs.atlassian.net/browse/stella-3568) | APPLIED | v1 | 100% | [email](https://lists.ubuntu.com/archives/kernel-team/2026-August/171150.html) | August 2026 | Chia-Lin |
| `38573fd563ab` | ASoC: SDCA: Move kcontrol search out of IRQ | [2163215](https://bugs.launchpad.net/bugs/2163215) | [cpl-325](https://warthogs.atlassian.net/browse/cpl-325) | ACK/CMNT*2 | v2 | 100% | [email](https://lists.ubuntu.com/archives/kernel-team/2026-August/171241.html) | August 2026 | Chris |
| `d9db0ad11c05` | ASoC: SDCA: Switch to fixup_controls callback for IRQ registration | [2163215](https://bugs.launchpad.net/bugs/2163215) | [cpl-325](https://warthogs.atlassian.net/browse/cpl-325) | ACK/CMNT*2 | v2 | 100% | [email](https://lists.ubuntu.com/archives/kernel-team/2026-August/171240.html) | August 2026 | Chris |
| `0f380e30f69f` | ASoC: Add a component fixup_controls callback | [2163215](https://bugs.launchpad.net/bugs/2163215) | [cpl-325](https://warthogs.atlassian.net/browse/cpl-325) | ACK/CMNT*2 | v2 | 100% | [email](https://lists.ubuntu.com/archives/kernel-team/2026-August/171239.html) | August 2026 | Chris |
| `38cf850fdb21` | ASoC: SDCA: Populate IRQ data earlier | [2163215](https://bugs.launchpad.net/bugs/2163215) | [cpl-325](https://warthogs.atlassian.net/browse/cpl-325) | ACK/CMNT*2 | v2 | 100% | [email](https://lists.ubuntu.com/archives/kernel-team/2026-August/171238.html) | August 2026 | Chris |
| `ef19b0a3e699` | ASoC: SDCA: Remove devm from primary IRQ cleanup | [2163215](https://bugs.launchpad.net/bugs/2163215) | [cpl-325](https://warthogs.atlassian.net/browse/cpl-325) | ACK/CMNT*2 | v2 | 100% | [email](https://lists.ubuntu.com/archives/kernel-team/2026-August/171236.html) | August 2026 | Chris |
| `71959b21f984` | ASoC: SDCA: Add sdca_irq_cleanup_late() | [2163215](https://bugs.launchpad.net/bugs/2163215) | [cpl-325](https://warthogs.atlassian.net/browse/cpl-325) | ACK/CMNT*2 | v2 | 100% | [email](https://lists.ubuntu.com/archives/kernel-team/2026-August/171235.html) | August 2026 | Chris |
| `b2e62a968554` | ASoC: SDCA: Rename sdca_irq_allocate() to include devm | [2163215](https://bugs.launchpad.net/bugs/2163215) | [cpl-325](https://warthogs.atlassian.net/browse/cpl-325) | ACK/CMNT*2 | v2 | 100% | [email](https://lists.ubuntu.com/archives/kernel-team/2026-August/171233.html) | August 2026 | Chris |
| `a5979f4d88c1` | ASoC: SDCA: Correct kernel doc for sdca_irq_cleanup() | [2163215](https://bugs.launchpad.net/bugs/2163215) | [cpl-325](https://warthogs.atlassian.net/browse/cpl-325) | ACK/CMNT*2 | v2 | 100% | [email](https://lists.ubuntu.com/archives/kernel-team/2026-August/171234.html) | August 2026 | Chris |
...
| `88c7115617e3` | UBUNTU: SAUCE: drm/i915/tc: Revert forced DP-alt connected workaround | [2160082](https://bugs.launchpad.net/bugs/2160082) | [cpl-327](https://warthogs.atlassian.net/browse/cpl-327) | APPLIED | v2 | 100% | [email](https://lists.ubuntu.com/archives/kernel-team/2026-August/171203.html) | August 2026 | ChunAn |
